...
Exercises 3.1, 3.2, 3.3 and 3.8 from the Hyndman online Forecasting book. The rpubs version of this work can be found [here](https://rpubs.com/plb_lttfer/572895), and source/data can be found on github [here](https://github.com/plb2018/DATA624/tree/master/Homework1).
...
Here we look at how RMSE (just to pick one of the measures of model accudacy) varies as we modify the train/test split.  Here we look at an out-sample size of 1 to 190 (where 190 == half of the data).  We can see that the RMSE varies dramatically as the relative split changes and can conclude that yes, the accuracy measures are quite sensitive in this case.
