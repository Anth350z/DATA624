...
Exercises 6.2 and 6.3 from the Hyndman online Forecasting book. The rpubs version of this work can be found [here](https://rpubs.com/plb_lttfer/577576), and source/data can be found on github [here](https://github.com/plb2018/DATA624/tree/master/Homework3).
